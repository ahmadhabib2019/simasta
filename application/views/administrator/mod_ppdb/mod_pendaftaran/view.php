  ...
  <div class="box">
    ...
    <table id='example1' class='table table-bordered table-striped'>
      ...
      echo "<tr>
                ...
                if ($pendaftar->num_rows()>=1){
                  echo "<td style='width:210px !important'><b>$jal[jalur] : </b> <span style='color:blue'>1. $pilihan1</span> <br><span style='color:blue'>2. $pilihan2</span></td>";
                }else{
                    ...
                    <div class='btn-group'> 
                      ...
                      <button type='button' class='btn btn-$color btn-xs dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'> <span class='caret'></span> <span class='sr-only'>Toggle Dropdown</span> </button> 
                        <ul class='dropdown-menu'> 
                          <li><a href='".base_url().$this->uri->segment(1)."/pendaftaran?id=$cek[id_pendaftaran]&status=Terima' onclick=\"return confirm('Apa anda yakin untuk datanya Sudah Valid?')\"><span class='glyphicon glyphicon-ok'></span> Sudah Valid</a></li> 
