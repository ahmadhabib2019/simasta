        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-list-ul"></i> <span>Referensi</span><i class="fa fa-angle-left pull-right"></i></a>
            ...
            <!--<li class="treeview">
              ...
              <?php
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li class='treeview'>
                        <a href='#'><i class='fa fa-circle-o'></i> Humas DUDI
                          <span class='pull-right-container'>
                            <i class='fa fa-angle-left pull-right'></i>
                          </span>
                        </a>
            ...
            <li class="treeview">
              ...
              <?php
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url()."$sekolah[keyword]/guru'><i class='fa fa-circle-o'></i> Guru</a></li>";
                }
