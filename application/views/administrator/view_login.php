  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a style='display:block' href="#">SMK <b>LIMAKODE</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <?php 
          echo "<center><img style='width:200px' src='".base_url()."asset/admin/dist/img/sekolah.png'></center><br />";
        ...
        ?>
         <p class="login-box-msg">Silahkan Login Pada Form dibawah ini</p>
          ...
          <div class="form-group has-feedback">
            <?php
            echo "<center><input style='background:#e3e3e3;border:0px; padding:7px; display:inline-block; width:60px; text-align:right' type='number' class='required number' value='".rand(1,25)."' name='angka1' onkeyup=\"nospaces(this)\" autocomplete=off readonly=on> + 
            <input style='background:#e3e3e3;border:0px; padding:7px; display:inline-block; width:60px; text-align:right' type='number'  value='".rand(1,25)."' class='required number' name='angka2' onkeyup=\"nospaces(this)\" autocomplete=off  readonly=on> = 
            <input type='number' style='width:150px; display:inline-block' class='form-control' name='c' placeholder='Jawaban' onkeyup=\"nospaces(this)\" autocomplete=off required></center>";
            ?>
          </div>
          <div class="row">
            <div class="col-xs-8">
