    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper" style='padding-top: 60px;'>
        <section class="content-header">
          <?php 
            $judul = $this->model_app->view_where('rb_modul_title',array('view'=>$this->uri->segment(2)));
            $row = $judul->row_array();
            if ($judul->num_rows()>=1){
              echo "<h1> $row[judul]<small>$row[keterangan] </small> </h1>";
            }else{
              echo "<h1> Dashboard <small>Control panel </small> </h1>";
            }
          ?>
        </section>
