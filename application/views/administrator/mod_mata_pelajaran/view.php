                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                ...
                                if ($this->session->id_session=='1'){
                                  echo "<a style='margin-left:3px' class='btn btn-danger btn-xs' title='Delete Data' href='".base_url().$this->uri->segment(1)."/delete_mata_pelajaran/$r[id_mata_pelajaran]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>";
                                }
                              echo "</center></td>
                              </tr>";
                      $no++;
