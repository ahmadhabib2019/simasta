              ...
              echo form_open_multipart($this->uri->segment(1).'/edit_guru',$attributes); 
                echo "<div class='col-md-7'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Nip</th>      <td><input type='text' class='form-control' name='nip' value='$s[nip]'></td></tr>
                    <tr><th scope='row'>Username/Email</th>         <td><input type='email' class='form-control' name='email' value='$s[email]' required></td></tr>
